...
describe('E2E tests', function () {
  ...
  describe('Forum', () => {
    it('Show Posts', async () => {
      ...
      const form = await page.$$eval('.topic-container .topic-name-wrapper', (t) =>
    ...
    it('Create post', async () => {
      ...
      const [request] = await Promise.all([
        onRequest(),
        page.click('.public', { timeout: interval }),
      ]);
    ...
    it.only('Check post title', async () => {
      ...
      await page.click(`.topic-container .topic-name-wrapper .topic-name >> a h2`, {
        timeout: interval,
      });
